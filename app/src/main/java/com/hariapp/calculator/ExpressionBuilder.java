...
import com.hariapp.calculator.shuntingyard.ShuntingYard;
...
public class ExpressionBuilder {
    ...
    public Expression build() {
        ...
        return new Expression(ShuntingYard.convertToRPN(this.expression, this.userFunctions, this.userOperators, this.variableNames, this.implicitMultiplication),
